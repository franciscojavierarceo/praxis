...
| [`anthropic_to_openai`](http/ai/anthropic_to_openai.md) | `ai-inference` | Transforms Anthropic Messages API requests to `OpenAI` Chat Completions format and transforms responses back. |
